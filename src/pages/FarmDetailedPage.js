    ...
    <>
      ...
      {farmDetails && (
        ...
        <div className="mt-5 rounded">
          ...
          {/* 상세 정보 */}
          <div className="mx-5 mt-3 min-h-screen rounded-t-3xl bg-white px-5 pt-2 text-center">
            {/* 태그 */}
            ...
            <ol className="mb-3 flex justify-center gap-3">
              {/* 명소 1 */}
              <li className="">
            ...
            <div className="fixed bottom-5 rounded-xl bg-[#FFA500]">
              <button
                ...
                className="px-44 py-4 text-white"
              >
                예약하기
              </button>
            </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="custom-scrollbar mx-5 h-[36rem] overflow-y-auto rounded-[2rem] bg-white p-8 text-center shadow-md">
            ...
            <div className="text-left leading-8">
              ...
              <p className="">
                4. 개인정보 보호
                <br />· 예약 시 제공된 개인 정보는 예약 관리 목적으로만
              ...
              <p className="">
                ...
                <br />
                · 예약 취소가 체크인 24시간 이내에 이루어진 경우, 첫날 숙박
                요금이 부과됩니다.
