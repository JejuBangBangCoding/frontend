  ...
  return (
    <>
        ...
        {/* 모집 리스트 - 내용 (시작)) */}
          ...
          <div className="flex my-4 cursor-pointer">
            ...
            <div className="">
              ...
              <p className="font-thin text-[0.8rem] mb-[0.2rem]">애월읍 귤동 123</p>
          ...
          <div className="flex my-4 cursor-pointer">
            ...
            <div className="">
              ...
              <p className="font-thin text-[0.8rem] mb-[0.2rem]">애월읍 당근로 123</p>
              <div className="flex gap-[0.15rem]">
                <img src={star} alt="Star" className="w-[0.8rem]" />
          ...
          <div className="flex my-4 cursor-pointer">
            ...
            <div className="">
              ...
              <p className="font-thin text-[0.8rem] mb-[0.2rem]">제주시 애월읍 밭길 123</p>
              <div className="flex gap-[0.15rem]">
                <img src={star} alt="Star" className="w-[0.8rem]" />
      ...
      <div className="flex mb-5 justify-center gap-5">
        ...
        {/* 버튼 - 왼쪽 (시작)) */}
        <div className="box-border h-auto w-[10rem] p-5 bg-[#FFA500] rounded-[1.875rem] cursor-pointer">
